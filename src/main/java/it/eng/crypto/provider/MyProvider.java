...
public final class MyProvider extends Provider {
    ...
    // private static final String[] SYMMETRIC_CIPHERS = { "AES", "Camellia", "CAST5", "Grainv1", "Grain128", "IDEA",
    // "Noekeon", "SEED" };
    ...
    public MyProvider() {
        ...
        localHashMap.put("XMLSignatureFactory.DOM", "it.eng.crypto.provider.MyDOMXMLSignatureFactory");
        ...
        localHashMap.put("TransformService.http://www.w3.org/TR/2001/REC-xml-c14n-20010315#WithComments MechanismType",
                "DOM");
        ...
        // put("Alg.Alias.AlgorithmParameters." + BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes128_cbc.getId(),
        // "PKCS12PBE");
        // put("Alg.Alias.AlgorithmParameters." + BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes192_cbc.getId(),
        // "PKCS12PBE");
        // put("Alg.Alias.AlgorithmParameters." + BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes256_cbc.getId(),
        // "PKCS12PBE");
        // put("Alg.Alias.AlgorithmParameters." + BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes128_cbc.getId(),
        // "PKCS12PBE");
        // put("Alg.Alias.AlgorithmParameters." + BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes192_cbc.getId(),
        // "PKCS12PBE");
        // put("Alg.Alias.AlgorithmParameters." + BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes256_cbc.getId(),
        // "PKCS12PBE");
        ...
        // put("Alg.Alias.SecretKeyFactory." + BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes128_cbc.getId(),
        // "PBEWITHSHAAND128BITAES-CBC-BC");
        // put("Alg.Alias.SecretKeyFactory." + BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes192_cbc.getId(),
        // "PBEWITHSHAAND192BITAES-CBC-BC");
        // put("Alg.Alias.SecretKeyFactory." + BCObjectIdentifiers.bc_pbe_sha1_pkcs12_aes256_cbc.getId(),
        // "PBEWITHSHAAND256BITAES-CBC-BC");
        // put("Alg.Alias.SecretKeyFactory." + BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes128_cbc.getId(),
        // "PBEWITHSHA256AND128BITAES-CBC-BC");
        // put("Alg.Alias.SecretKeyFactory." + BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes192_cbc.getId(),
        // "PBEWITHSHA256AND192BITAES-CBC-BC");
        // put("Alg.Alias.SecretKeyFactory." + BCObjectIdentifiers.bc_pbe_sha256_pkcs12_aes256_cbc.getId(),
        // "PBEWITHSHA256AND256BITAES-CBC-BC");
        // addMacAlgorithms();
        ...
        for (int i = 0; i != paramArrayOfString.length; ++i) {
            ...
            try {
                ...
                if (localClassLoader != null)
                    localClass = localClassLoader.loadClass(paramString + paramArrayOfString[i] + "Mappings");
                else
            ...
            try {
                ...
                throw new InternalError("cannot create instance of " + paramString + paramArrayOfString[i]
                        + "Mappings : " + localException);
            }
        }
    }
        ...
        while (localIterator.hasNext()) {
            ...
            if (containsKey(localObject))
                throw new IllegalStateException(
                        "duplicate provider key (" + localObject + ") found in " + paramMap.getClass().getName());
    ...
    // }
    //
    // private void addSignatureAlgorithm(String paramString1, String paramString2, String paramString3,
