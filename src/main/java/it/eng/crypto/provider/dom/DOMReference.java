...
public final class DOMReference extends DOMStructure implements Reference, DOMURIReference {
    ...
    /**
     * Look up useC14N11 system property. If true, an explicit C14N11 transform will be added if necessary when
     * generating the signature. See section 3.1.1 of http://www.w3.org/2007/xmlsec/Drafts/xmldsig-core/ for more info.
     *
     ...
     *            the digest method
     * @param transforms
     *            a list of {@link Transform}s. The list is defensively copied to protect against subsequent
     ...
     *             if any of the <code>transforms</code> are not of type <code>Transform</code>
     */
    ...
    public DOMReference(String uri, String type, DigestMethod dm, List appliedTransforms, Data result, List transforms,
