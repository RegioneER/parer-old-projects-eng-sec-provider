...
public class DOMCanonicalizationMethod extends DOMTransform implements CanonicalizationMethod {
    ...
    /**
     * Creates a <code>DOMCanonicalizationMethod</code> from an element. This ctor invokes the
     * abstract {@link #unmarshalParams unmarshalParams} method to unmarshal any algorithm-specific
     * input parameters.
     *
    ...
    /**
     * Canonicalizes the specified data using the underlying canonicalization algorithm. This is a
     * convenience method that is equivalent to invoking the {@link #transform transform} method.
     *
     * @param data the data to be canonicalized
     * @param xc   the <code>XMLCryptoContext</code> containing additional context (may be
