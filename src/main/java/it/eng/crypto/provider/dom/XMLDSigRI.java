...
public final class XMLDSigRI extends Provider {
    ...
    public XMLDSigRI() {
        ...
        map.put((String) "TransformService." + CanonicalizationMethod.INCLUSIVE + " MechanismType",
                "DOM");
        ...
        map.put((String) "TransformService." + CanonicalizationMethod.EXCLUSIVE + " MechanismType",
                "DOM");
