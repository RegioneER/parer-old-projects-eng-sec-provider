...
public final class DOMSignedInfo extends DOMStructure implements SignedInfo {
    ...
    /**
     * Creates a <code>DOMSignedInfo</code> from the specified parameters. Use this constructor when
     * the <code>Id</code> is not specified.
     *
     ...
     *                                  <code>references</code> is <code>null</code>
     * @throws IllegalArgumentException if <code>references</code> is empty
     * @throws ClassCastException       if any of the references are not of type
     *                                  <code>Reference</code>
     */
     ...
     * @param sm         the signature method
     * @param references the list of references. The list is copied.
     * @param id         an optional identifer that will allow this <code>SignedInfo</code> to be
