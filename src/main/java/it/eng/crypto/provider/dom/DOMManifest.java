...
public final class DOMManifest extends DOMStructure implements Manifest {
    ...
    /**
     * Creates a <code>DOMManifest</code> containing the specified list of {@link Reference}s and
     * optional id.
     *
     * @param references a list of one or more <code>Reference</code>s. The list is defensively
     *                   copied to protect against subsequent modification.
     * @param id         the id (may be <code>null</code>
     *
     * @throws NullPointerException     if <code>references</code> is <code>null</code>
     * @throws IllegalArgumentException if <code>references</code> is empty
     * @throws ClassCastException       if <code>references</code> contains any entries that are not
	...
	Element manElem = DOMUtils.createElement(ownerDoc, "Manifest", XMLSignature.XMLNS,
		dsPrefix);
