...
public final class DOMSignatureProperties extends DOMStructure implements SignatureProperties {
     ...
     *
     * @param properties a list of one or more {@link SignatureProperty}s. The list is defensively
     *                   copied to protect against subsequent modification.
     * @param id         the Id (may be <code>null</code>)
     *
     * @return a <code>DOMSignatureProperties</code>
     *
     * @throws ClassCastException       if <code>properties</code> contains any entries that are not
    ...
    public void marshal(Node parent, String dsPrefix, DOMCryptoContext context)
        ...
        Element propsElem = DOMUtils.createElement(ownerDoc, "SignatureProperties",
