...
public final class DOMSignatureProperty extends DOMStructure implements SignatureProperty {
     ...
     *
     * @param content
     *            a list of one or more {@link XMLStructure}s. The list is defensively copied to protect against
     ...
     *             if <code>content</code> or <code>target</code> is <code>null</code>
     */
    ...
    public void marshal(Node parent, String dsPrefix, DOMCryptoContext context) throws MarshalException {
        ...
        Element propElem = DOMUtils.createElement(ownerDoc, "SignatureProperty", XMLSignature.XMLNS, dsPrefix);
        ...
        for (int i = 0, size = content.size(); i < size; i++) {
            javax.xml.crypto.dom.DOMStructure property = (javax.xml.crypto.dom.DOMStructure) content.get(i);
    ...
    public boolean equals(Object o) {
        ...
        return (equalsContent(osp.getContent()) && target.equals(osp.getTarget()) && idsEqual);
    }
