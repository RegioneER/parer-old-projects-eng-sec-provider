...
public final class DOMKeyInfo extends DOMStructure implements KeyInfo {
     ...
     *
     * @param content a list of one or more {@link XMLStructure}s representing key information
     *                types. The list is defensively copied to protect against subsequent
     *                modification.
    ...
    public void marshal(XMLStructure parent, XMLCryptoContext context) throws MarshalException {
        ...
        Element kiElem = DOMUtils.createElement(DOMUtils.getOwnerDocument(pNode), "KeyInfo",
                XMLSignature.XMLNS, dsPrefix);
        if (dsPrefix == null || dsPrefix.length() == 0) {
            kiElem.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns", XMLSignature.XMLNS);
        } else {
            kiElem.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:" + dsPrefix,
                    XMLSignature.XMLNS);
        }
    ...
    public void marshal(Node parent, Node nextSibling, String dsPrefix, DOMCryptoContext context)
        ...
        Element kiElem = DOMUtils.createElement(ownerDoc, "KeyInfo", XMLSignature.XMLNS, dsPrefix);
