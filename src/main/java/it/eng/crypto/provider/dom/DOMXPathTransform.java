...
/**
 * DOM-based implementation of XPath Filtering Transform. (Uses Apache XML-Sec Transform
 * implementation)
 *
 * @author Sean Mullan
 */
public final class DOMXPathTransform extends ApacheTransform {
    ...
    public void marshalParams(XMLStructure parent, XMLCryptoContext context)
        ...
        while (i.hasNext()) {
            ...
            xpathElem.setAttributeNS("http://www.w3.org/2000/xmlns/",
                    "xmlns:" + (String) entry.getKey(), (String) entry.getValue());
        }
