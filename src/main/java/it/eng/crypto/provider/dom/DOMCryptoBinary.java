...
/**
 * A DOM-based representation of the XML <code>CryptoBinary</code> simple type as defined in the W3C
 * specification for XML-Signature Syntax and Processing. The XML Schema Definition is defined as:
 *
 * <xmp> <simpleType name="CryptoBinary"> <restriction base = "base64Binary"> </restriction>
 * </simpleType> </xmp>
 *
 * @author Sean Mullan
 */
