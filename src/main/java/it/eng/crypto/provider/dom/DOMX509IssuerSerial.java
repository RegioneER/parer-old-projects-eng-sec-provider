...
public final class DOMX509IssuerSerial extends DOMStructure implements X509IssuerSerial {
    ...
    /**
     * Creates a <code>DOMX509IssuerSerial</code> containing the specified issuer distinguished
     * name/serial number pair.
     *
     * @param issuerName   the X.509 issuer distinguished name in RFC 2253 String format
     * @param serialNumber the serial number
     *
     * @throws IllegalArgumentException if the format of <code>issuerName</code> is not RFC 2253
     *                                  compliant
     * @throws NullPointerException     if <code>issuerName</code> or <code>serialNumber</code> is
     *                                  <code>null</code>
     */
