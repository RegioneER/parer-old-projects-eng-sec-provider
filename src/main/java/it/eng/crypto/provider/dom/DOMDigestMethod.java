 ...
 */
/*
 * $Id: DOMDigestMethod.java 647272 2008-04-11 19:22:21Z mullan $
 */
...
public abstract class DOMDigestMethod extends DOMStructure implements DigestMethod {
    ...
    final static String SHA384 = "http://www.w3.org/2001/04/xmldsig-more#sha384"; // see RFC 4051
    ...
    /**
     * Creates a <code>DOMDigestMethod</code> from an element. This constructor invokes the abstract
     ...
     * parameters are specified since most DigestMethod algorithms do not have parameters. Subclasses should override it
     * if they have parameters.
     *
     * @param params
     *            the algorithm-specific params (may be <code>null</code>)
     * 
    ...
    /**
     * Unmarshals <code>DigestMethodParameterSpec</code> from the specified <code>Element</code>. By default, this
     * method throws an exception since most DigestMethod algorithms do not have parameters. Subclasses should override
    ...
    DigestMethodParameterSpec unmarshalParams(Element paramsElem) throws MarshalException {
        throw new MarshalException("no parameters should " + "be specified for the " + getMessageDigestAlgorithm()
    ...
    public void marshal(Node parent, String prefix, DOMCryptoContext context) throws MarshalException {
        ...
        Element dmElem = DOMUtils.createElement(ownerDoc, "DigestMethod", XMLSignature.XMLNS, prefix);
     ...
     * default, this method throws an exception since most DigestMethod algorithms do not have parameters. Subclasses
