...
public abstract class DOMDigestMethod extends DOMStructure implements DigestMethod {
     ...
     * throws an exception if parameters are specified since most DigestMethod algorithms do not
    ...
    void checkParams(DigestMethodParameterSpec params) throws InvalidAlgorithmParameterException {
        if (params != null) {
            throw new InvalidAlgorithmParameterException(
                    "no parameters " + "should be specified for the " + getMessageDigestAlgorithm()
    ...
    /**
     * Unmarshals <code>DigestMethodParameterSpec</code> from the specified <code>Element</code>. By
     * default, this method throws an exception since most DigestMethod algorithms do not have
    ...
    public void marshal(Node parent, String prefix, DOMCryptoContext context)
        ...
        Element dmElem = DOMUtils.createElement(ownerDoc, "DigestMethod", XMLSignature.XMLNS,
                prefix);
     ...
     * parent element. By default, this method throws an exception since most DigestMethod
