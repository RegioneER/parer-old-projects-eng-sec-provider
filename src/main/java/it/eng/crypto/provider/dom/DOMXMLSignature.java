...
public final class DOMXMLSignature extends DOMStructure implements XMLSignature {
     ...
     *
     * @param si
     *            the <code>SignedInfo</code>
     * @param ki
     *            the <code>KeyInfo</code>, or <code>null</code> if not specified
     * @param objs
     *            a list of <code>XMLObject</code>s or <code>null</code> if not specified. The list is copied to protect
    ...
    public void marshal(Node parent, Node nextSibling, String dsPrefix, DOMCryptoContext context)
        ...
        if (dsPrefix == null || dsPrefix.length() == 0) {
            ...
            sigElem.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns:" + dsPrefix, XMLSignature.XMLNS);
        }
    ...
    public class DOMSignatureValue extends DOMStructure implements SignatureValue {
        ...
        public boolean validate(XMLValidateContext validateContext) throws XMLSignatureException {
            ...
            try {
                validationStatus = ((DOMSignatureMethod) sm).verify(validationKey, (DOMSignedInfo) si, value,
                        validateContext);
            } catch (Exception e) {
        ...
        public void marshal(Node parent, String dsPrefix, DOMCryptoContext context) throws MarshalException {
            ...
            sigValueElem = DOMUtils.createElement(ownerDoc, "SignatureValue", XMLSignature.XMLNS, dsPrefix);
            if (valueBase64 != null) {
