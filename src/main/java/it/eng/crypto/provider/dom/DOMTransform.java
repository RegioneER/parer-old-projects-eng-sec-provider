...
public class DOMTransform extends DOMStructure implements Transform {
    ...
    /**
     * Creates a <code>DOMTransform</code> from an element. This constructor invokes the abstract
    ...
    public void marshal(Node parent, String dsPrefix, DOMCryptoContext context)
        ...
        if (parent.getLocalName().equals("Transforms")) {
            transformElem = DOMUtils.createElement(ownerDoc, "Transform", XMLSignature.XMLNS,
                    dsPrefix);
        } else {
            transformElem = DOMUtils.createElement(ownerDoc, "CanonicalizationMethod",
     ...
     * @param sc   the <code>XMLCryptoContext</code> containing additional context (may be
     *             <code>null</code> if not applicable)
     *
     * @return the transformed data
     *
     * @throws NullPointerException  if <code>data</code> is <code>null</code>
     * @throws XMLSignatureException if an unexpected error occurs while executing the transform
     */
     ...
     * @param sc   the <code>XMLCryptoContext</code> containing additional context (may be
     *             <code>null</code> if not applicable)
     * @param os   the <code>OutputStream</code> that should be used to write the transformed data
     *             to
     *
     * @return the transformed data
     *
    ...
    public boolean equals(Object o) {
        ...
        return (getAlgorithm().equals(otransform.getAlgorithm())
                && DOMUtils.paramsEqual(getParameterSpec(), otransform.getParameterSpec()));
    }
    ...
    /**
     * Transforms the specified data using the underlying transform algorithm. This method invokes
     * the {@link #marshal marshal} method and passes it the specified <code>DOMSignContext</code>
     ...
     * @throws NullPointerException  if <code>data</code> or <code>context</code> is
     *                               <code>null</code>
     * @throws XMLSignatureException if an unexpected error occurs while executing the transform
     */
