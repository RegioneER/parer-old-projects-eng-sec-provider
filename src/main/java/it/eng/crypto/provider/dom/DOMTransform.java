...
public class DOMTransform extends DOMStructure implements Transform {
    ...
    public void marshal(Node parent, String dsPrefix, DOMCryptoContext context) throws MarshalException {
        ...
        if (parent.getLocalName().equals("Transforms")) {
            transformElem = DOMUtils.createElement(ownerDoc, "Transform", XMLSignature.XMLNS, dsPrefix);
        } else {
            transformElem = DOMUtils.createElement(ownerDoc, "CanonicalizationMethod", XMLSignature.XMLNS, dsPrefix);
        }
     ...
     *             if an unexpected error occurs while executing the transform
     */
    ...
    /**
     * Transforms the specified data using the underlying transform algorithm. This method invokes the {@link #marshal
     * marshal} method and passes it the specified <code>DOMSignContext</code> before transforming the data.
     *
     * @param data
     *            the data to be transformed
     * @param sc
     ...
     * @throws NullPointerException
     *             if <code>data</code> or <code>context</code> is <code>null</code>
     * @throws XMLSignatureException
     *             if an unexpected error occurs while executing the transform
     */
