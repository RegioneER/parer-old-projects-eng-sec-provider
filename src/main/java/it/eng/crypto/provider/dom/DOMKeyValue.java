...
public final class DOMKeyValue extends DOMStructure implements KeyValue {
        ...
        if (publicKey != null) {
            if (publicKey instanceof DSAPublicKey) {
                ...
                throw new MarshalException(
                        publicKey.getAlgorithm() + " public key algorithm not supported");
            }
        } else {
    ...
    private void marshalDSAPublicKey(Node parent, Document doc, String dsPrefix,
            DOMCryptoContext context) throws MarshalException {
    ...
    private void marshalRSAPublicKey(Node parent, Document doc, String dsPrefix,
            DOMCryptoContext context) throws MarshalException {
        ...
        Element exponentElem = DOMUtils.createElement(doc, "Exponent", XMLSignature.XMLNS,
                dsPrefix);
    ...
    private DSAPublicKey unmarshalDSAKeyValue(Element kvtElem) throws MarshalException {
        ...
        DSAPublicKeySpec spec = new DSAPublicKeySpec(y.getBigNum(), p.getBigNum(), q.getBigNum(),
                g.getBigNum());
