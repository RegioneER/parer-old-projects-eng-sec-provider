...
public final class DOMKeyValue extends DOMStructure implements KeyValue {
    ...
    public void marshal(Node parent, String dsPrefix, DOMCryptoContext context) throws MarshalException {
        ...
        Element kvElem = DOMUtils.createElement(ownerDoc, "KeyValue", XMLSignature.XMLNS, dsPrefix);
        marshalPublicKey(kvElem, ownerDoc, dsPrefix, context);

        parent.appendChild(kvElem);
    }

    private void marshalPublicKey(Node parent, Document doc, String dsPrefix, DOMCryptoContext context)
        ...
        if (publicKey != null) {
            if (publicKey instanceof DSAPublicKey) {
                ...
                throw new MarshalException(publicKey.getAlgorithm() + " public key algorithm not supported");
            }
        } else {
    ...
    private void marshalDSAPublicKey(Node parent, Document doc, String dsPrefix, DOMCryptoContext context)
            throws MarshalException {
    ...
    private void marshalRSAPublicKey(Node parent, Document doc, String dsPrefix, DOMCryptoContext context)
            throws MarshalException {
    ...
    private DSAPublicKey unmarshalDSAKeyValue(Element kvtElem) throws MarshalException {
        ...
        DSAPublicKeySpec spec = new DSAPublicKeySpec(y.getBigNum(), p.getBigNum(), q.getBigNum(), g.getBigNum());
