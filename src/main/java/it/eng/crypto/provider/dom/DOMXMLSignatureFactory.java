 ...
 */
/*
 * $Id: DOMXMLSignatureFactory.java 793943 2009-07-14 15:33:19Z coheigea $
 */
...
public final class DOMXMLSignatureFactory extends XMLSignatureFactory {
    ...
    public XMLSignature newXMLSignature(SignedInfo si, KeyInfo ki, List objects, String id,
    ...
    public Reference newReference(String uri, DigestMethod dm, List transforms, String type,
            String id) {
        return new DOMReference(uri, type, dm, transforms, id, getProvider());
    }

    public Reference newReference(String uri, DigestMethod dm, List appliedTransforms, Data result,
        ...
        return new DOMReference(uri, type, dm, appliedTransforms, result, transforms, id,
                getProvider());
    }
    ...
    public Reference newReference(String uri, DigestMethod dm, List transforms, String type,
        ...
        return new DOMReference(uri, type, dm, null, null, transforms, id, digestValue,
                getProvider());
    }

    public SignedInfo newSignedInfo(CanonicalizationMethod cm, SignatureMethod sm,
            List references) {
    ...
    private XMLSignature unmarshal(Node node, XMLValidateContext context) throws MarshalException {
