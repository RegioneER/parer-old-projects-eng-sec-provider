...
public final class DOMX509Data extends DOMStructure implements X509Data {
     ...
     *
     * @param content a list of one or more X.509 data types. Valid types are {@link String}
     *                (subject names), <code>byte[]</code> (subject key ids),
     *                {@link java.security.cert.X509Certificate}, {@link X509CRL}, or
     *                {@link javax.xml.dsig.XMLStructure} ({@link X509IssuerSerial} objects or
     *                elements from an external namespace). The list is defensively copied to
     ...
     * @throws ClassCastException       if <code>content</code> contains any entries that are not of
    ...
    public DOMX509Data(List content) {
        ...
        for (int i = 0, size = contentCopy.size(); i < size; i++) {
            ...
            } else if (!(x509Type instanceof byte[]) && !(x509Type instanceof X509Certificate)
                    && !(x509Type instanceof X509CRL) && !(x509Type instanceof XMLStructure)) {
    ...
    public void marshal(Node parent, String dsPrefix, DOMCryptoContext context)
        ...
        Element xdElem = DOMUtils.createElement(ownerDoc, "X509Data", XMLSignature.XMLNS, dsPrefix);
    ...
    private void marshalSKI(byte[] skid, Node parent, Document doc, String dsPrefix) {
        ...
        Element skidElem = DOMUtils.createElement(doc, "X509SKI", XMLSignature.XMLNS, dsPrefix);
    ...
    private void marshalSubjectName(String name, Node parent, Document doc, String dsPrefix) {
        ...
        Element snElem = DOMUtils.createElement(doc, "X509SubjectName", XMLSignature.XMLNS,
                dsPrefix);
    ...
    private void marshalCert(X509Certificate cert, Node parent, Document doc, String dsPrefix)
        ...
        Element certElem = DOMUtils.createElement(doc, "X509Certificate", XMLSignature.XMLNS,
                dsPrefix);
        try {
    ...
    private void marshalCRL(X509CRL crl, Node parent, Document doc, String dsPrefix)
        ...
        Element crlElem = DOMUtils.createElement(doc, "X509CRL", XMLSignature.XMLNS, dsPrefix);
        try {
