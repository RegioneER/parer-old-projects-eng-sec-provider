...
public final class DOMX509Data extends DOMStructure implements X509Data {
     ...
     *
     * @param content
     *            a list of one or more X.509 data types. Valid types are {@link String} (subject names),
     ...
     *             if <code>content</code> contains any entries that are not of one of the valid types mentioned above
     */
    ...
    private void marshalSubjectName(String name, Node parent, Document doc, String dsPrefix) {
        ...
        Element snElem = DOMUtils.createElement(doc, "X509SubjectName", XMLSignature.XMLNS, dsPrefix);
    ...
    private void marshalCert(X509Certificate cert, Node parent, Document doc, String dsPrefix) throws MarshalException {
        ...
        Element certElem = DOMUtils.createElement(doc, "X509Certificate", XMLSignature.XMLNS, dsPrefix);
        try {
